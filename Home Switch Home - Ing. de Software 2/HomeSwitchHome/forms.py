...
class RegistroForm(forms.Form):
    ...
    marca_tarjeta_credito = forms.ChoiceField(widget=forms.RadioSelect, choices=[('VISA', 'Visa'), ('AMERICAN EXPRESS', 'American Express'), ('MASTERCARD', 'Mastercard')])
    nombre_titular_tarjeta = forms.CharField()
    fecha_vencimiento_tarjeta = forms.DateField()
    codigo_seguridad_tarjeta = forms.IntegerField()
